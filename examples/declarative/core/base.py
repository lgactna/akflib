...
class AKFModule(abc.ABC):
    ...
    @property
    @abc.abstractmethod
    def dependencies(self) -> set[ModuleType]:
        """
    ...
    def verify_models(
        ...
        """
        Parse the arguments and configuration for this module.
        
        This method is used to parse the arguments and configuration for this module
        using the Pydantic models defined in the `arg_model` and `config_model` 
        properties.
        """
        arg_obj = cls.arg_model.model_validate(args)
        config_obj = cls.config_model.model_validate(config)
        
        return arg_obj, config_obj
